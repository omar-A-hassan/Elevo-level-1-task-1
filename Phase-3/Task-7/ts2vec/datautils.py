...
def load_forecast_csv(name, univar=False):
    ...
    elif name.startswith('walmart'):
        # For Walmart data (143 weeks total), use shorter horizons suitable for weekly retail data
        # 1, 4, 8, 12, 24 weeks = 1 week, 1 month, 2 months, 3 months, 6 months
        pred_lens = [1, 4, 8, 12, 24]
